...
public class MainSecurity extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable(); //cors side request forgery
                ...
                .antMatchers(HttpMethod.DELETE, "/product/**", "/category/**", "/city/**", "/feature/**", "/policy/**", "/auth/**", "/user/**").permitAll()//.hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/auth/**", "/user/**").permitAll()//.hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/booking/**"/*"/auth/**"*/).permitAll()//.hasAnyRole("USER", "ADMIN")
                ...
                .antMatchers(HttpMethod.GET, "/booking/**").permitAll()//.hasAnyRole("USER", "ADMIN")
